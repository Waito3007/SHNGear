import { BarChart2, DollarSign, Menu, Settings, ShoppingBag, ShoppingCart, TrendingUp, Users, Home, Layout } from "lucide-react";
...
const SIDEBAR_ITEMS = [
	...
	{ name: "Trang chủ", icon: Layout, color: "#06B6D4", href: "/admin/homepage" },
