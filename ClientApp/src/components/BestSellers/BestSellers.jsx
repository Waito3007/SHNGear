    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const productsResponse = await fetch("https://localhost:7107/api/Products");
                if (!productsResponse.ok) throw new Error("Không thể tải sản phẩm");
                const productsData = await productsResponse.json();

                // Lấy danh sách danh mục
                const categoriesResponse = await fetch("https://localhost:7107/api/categories");
                ...
                console.log("Dữ liệu API trả về:", { productsData, categoriesData, brandsData });
